...
// The first test is just to see whether it can learn basic short term dependencies.
// It keep blowing up even with momentum. I'll freeze this like so and try Rprop.

// ...It seems the problem was the lack of output nonlinear activations and improperly initialized weights.

// Mostly, the lack of output nonlinearities.

// The biases do nothing for this net which is not what I expected.
// Actually scratch the above. For the net with 10 hidden units, they are actively harmful. They sometimes lead to much faster
// convergence, but at the cost of causing it to blow up much more often.

// ...It is a dice roll. I might be getting fooled by randomness here. At least the are about even.

// Turns out there also was an error in backprop.
...
rnn weights_input_hidden weights_hidden_hidden weights_hidden_output 0.1f 0.9f 30