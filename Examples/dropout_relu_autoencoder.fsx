...
relu_dropout_autoencoder weights 0.025f 5 training_batches dtest_data
...
let test_time() =
    ...
    logistic_regression weights2 0.25f 1000 training_batches_sparse dtest_data_sparse
...
let save_bitmap() =
    ...
    bitmap.Save(@"C:\!NN\fixed_relu_dropout_1c.bmp")
save_bitmap()
...
let save_reconstruction() =
    ...
    bitmap.Save(@"C:\!NN\recon_fixed_droput_relu_1a.bmp")
save_reconstruction()
