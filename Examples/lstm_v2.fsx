...
// After much work I finally finished it, but I cannot make it converge.
// Given that it is 500 lines long even not counting the two modules I had to
// make for it which are now in utils.fsx, it is no wonder that something went
// wrong during the creation.

// With piecewise linear functions it converges to some point and get stuck there.

// With regular tanh and sigmoid it works best, though I had to change the targets
// from 1.0f to 0.5. My intention now is to try something simpler rather than wrack
// my brain regarding what is wrong here.

// I did managed to get to 0.03 error somehow.

// Instead of trying an LSTM with peepholes right of the bat, I should have done a GRU
// or at least a regular LSTM.
