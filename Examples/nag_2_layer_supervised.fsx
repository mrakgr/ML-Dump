// 2-layer net with Nesterov's Accelerated Momentum.
// Record: 98.99% with pretrained Relu units.
...
let momentum3 = setModule.Apply(0.0f,weights3)
...
let sparsenet_fine_tune weights weights2 weights3 learning_rate momentum_rate num_epochs (training_batches: (dM*dM) []) dtest_data start_k norm_constraint_l1 norm_constraint_l2 norm_constraint_l3 =
    ...
    let gradient (batch: dM) l start_k = 
        ...
        sgeam2 nT nT 1.0f weights3 momentum_rate momentum3 weights3 |> ignore
        ...
        sgemm2 nT T (-inv_batch_size*learning_rate) z2 squared_cost_error1 momentum_rate momentum3 |> ignore
        sgemm2 nT T (-inv_batch_size*learning_rate) z1 squared_cost_error2 momentum_rate momentum2 |> ignore
        sgemm2 nT T (-inv_batch_size*learning_rate) batch squared_cost_error3 momentum_rate momentum1 |> ignore
        ...
        sgeam2 nT nT 1.0f weights3 1.0f momentum3 weights3 |> ignore
...
sparsenet_fine_tune weights weights2 weights3 0.001f 0.999f 10 training_batches dtest_data 100 10.0f 10.0f 10.0f
