...
let weights = createRandomUniformMatrix 784 hidden_layer_width 1e-5f
//let weights = load_weights_mnist @"C:\!NN\1000i-25k-sparse-weights.bin"
worker.ProfilerStart()
sparse_autoencoder weights 0.01f 10 25 25
worker.Synchronize()
worker.ProfilerStop()
...
let a1 = sparseActivationModule.Apply(z1,25, z1)
let z2 = sgemm nT nT 1.0f weights a1 

let bitmap = make_bitmap_from_imageset z2 28 28 50 25
bitmap.Save(@"C:\!NN\recon_sparse_5.bmp")

save_weights @"C:\!NN\1000i-25k-sparse-weights.bin" weights
*)
