#r @"C:\Users\Marko\Documents\Visual Studio 2015\Projects\Automatic Differentiation\packages\DiffSharp.0.7.5\lib\net46\DiffSharp.dll"
...
let d_training_data = load_data @"C:\Temp\data" 
let d_target_data = load_data @"C:\Temp\target" 
...
let data = d_training_data
let targets = d_target_data

let weights = load_data @"C:\Temp\weights" 
let l1 = LSTMLayer.fromArray weights.[0..14] tanh tanh
let l2 = Layer.fromArray weights.[15..17] sigmoid

#time
let t = [|
    for i=1 to 1 do
        yield train_lstm_reber 100 5.0f d_training_data d_target_data 1.0f l1 l2 |] |> Array.concat
#time
